...
function number_type($number){
    ...
    $rest1 = substr($number, -1);//最后一位数字
    $rest2 = substr($number, -2, 1);//倒数第二位数字
    $rest3 = substr($number, -3, 1);//倒数第三位数字
    $rest4 = substr($number, -4, 1);//倒数第四位数字
    $rest5 = substr($number, -5, 1);//倒数第五位数字
    ...
    $mosaic_three = (string)($rest3.$rest2.$rest1);

    $mosaic_four = (string)($rest4.$rest3.$rest2.$rest1);

    $mosaic_five = (string)($rest5.$rest4.$rest3.$rest2.$rest1);
    ...
    if($len > 0 && $len ==1){
        ...
        if($len > 0 && $len == 2){
            ...
            if($len > 0 && $len == 3) {
                //三位数字连号123
                if($mosaic_three =='123' || $mosaic_three =='234' || $mosaic_three =='345' || $mosaic_three =='456' || $mosaic_three =='567' || $mosaic_three =='678' || $mosaic_three =='789'){
                    return '666';
                    //三位数字连号321
                }if($mosaic_three =='321' || $mosaic_three =='432' || $mosaic_three =='543' || $mosaic_three =='654' || $mosaic_three =='765' || $mosaic_three =='876' || $mosaic_three =='987'){
                    return '666';
                    //三位数字相同111
                }elseif($mosaic_three =='111' ||$mosaic_three =='222' ||$mosaic_three =='333' ||$mosaic_three =='444' ||$mosaic_three =='555' ||$mosaic_three =='666' ||$mosaic_three =='777' ||$mosaic_three =='888' ||$mosaic_three =='999'){
                    return '666';
                }elseif ($mosaic_three == '520') {
                    return '666';
                }else{
                    return '0';
                }
                ...
                if($len > 0 && $len == 4){
                    //四位数字连号1234-4567
                    if($mosaic_four == '1234' || $mosaic_four == '2345' || $mosaic_four == '3456' || $mosaic_four == '4567'){
                        return '1688';
                        //四位数字连号5678-6789
                    }elseif ($mosaic_four == '5678' || $mosaic_four == '6789'){
                        return '1888';
                        //四位数字连号4321-7654
                    }elseif($mosaic_four == '4321' || $mosaic_four == '5432' || $mosaic_four == '6543' || $mosaic_four == '7654'){
                        return '1888';
                        //四位数字连号8765-7654
                    }elseif ($mosaic_four == '8765' || $mosaic_four == '9876'){
                        return '2888';
                        //四位数字连号1111-5555
                    }elseif ($mosaic_four == '1111' || $mosaic_four == '2222' || $mosaic_four == '3333' ||$mosaic_four == '4444' ||$mosaic_four == '5555'){
                        return '1688';
                        //四位数字连号6666-8888
                    }elseif ($mosaic_four == '6666' || $mosaic_four == '8888'){
                        return '1888';
                        //四位数字连号9999
                    }elseif ($mosaic_four == '9999'){
                        return '3888';
                        //四位数字连号1314
                    }elseif ($mosaic_four == '1314') {
                        return '1688';
                    }else{
                        return '0';
                    }
                    ...
                    //五位数字
                    if($len > 0 && $len == 5) {
                        if ($mosaic_five == '12345') {
                            return '18888';
                        } elseif ($mosaic_five == '34567') {
                            return '18888';
                        } elseif ($mosaic_five == '11111') {
                            return '18888';
                        } elseif ($mosaic_five == '22288') {
                            return '18888';
                        } elseif ($mosaic_five == '33333') {
                            return '18888';
                        } elseif ($mosaic_five == '44444') {
                            return '18888';
                        } else {
                            return '0';
                        }
